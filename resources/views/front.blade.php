...
<head>
	...
	<title>Eliú - Bootstrap 5 Admin Template</title>
...
<body>
	<div class="wrapper">
		<nav id="" class="sidebar sidebar-light-primary">
				...
				<a class="sidebar-brand" href="index.html">
                    <span class="align-middle">
                        <div class="row">
                            ...
                            <div class="col-8 text-left" style="padding: 8px 0 0 0">
                                <h5><small class="text-info">Porque Ele é meu Deus!</small></h5>
                            </div>
                        </div>
                    </span>
                </a>
